 ...
 function certficate() {
    ...
    function pdf2() {
        ...
        .then(function (dataUrl) {
            ...
            pdf.addImage(dataUrl , 'PNG' , 1 , 5 ,imgWidth ,209  )
...
if(certficateData === "not found"){
  ...
  return   (certficateData != null) ?  (
    ...
    <p>
        السيد/ة : <input type="text" defaultValue={`${certficateData.data.data.id_data.first_name} ${certficateData.data.data.id_data.last_names}`} className='w-[50%]'/>
    </p>
    <p>
        عنوان المراسلات : <input type="text" defaultValue={certficateData.data.data.certificate_data.output.address} className='w-[100%]' />
    </p>
    </div>
     {/* end of patient info */}
     {/* company info  */}
    ...
    <p>هاتف24003600 ( 02)2(   + أو16816)</p>
    <p>فاكس : +  2 (02) 24003749</p>
...

{
    ...
    <p className="font">
        ...
        <span>  محل الإقامة : {certficateData.data.data.certificate_data.output.address}</span>
    </p>
